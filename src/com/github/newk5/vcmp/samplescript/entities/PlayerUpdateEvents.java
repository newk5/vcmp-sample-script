...
import com.github.newk5.vcmp.samplescript.controllers.MainController;
...
public class PlayerUpdateEvents {
    ...
    private MainController eventHandler;

    public PlayerUpdateEvents(MainController eventHandler) {
